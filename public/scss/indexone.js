...
function pcsavetimerTap(){
	...
	if(currentTimer == 'Countdown'){
		document.getElementById('timernumber').innerHTML = `${getTime(countdownseconds)[0]}:${getTime(countdownseconds)[1]}`;
		document.getElementById('timernumber1').innerHTML = `${getTime(countdownseconds)[0]}:${getTime(countdownseconds)[1]}`;
		document.getElementById('timernumber2').innerHTML = `${getTime(countdownseconds)[0]}:${getTime(countdownseconds)[1]}`;
	}else if(currentTimer == 'Stopwatch'){
		document.getElementById('timernumber').innerHTML = `${getTime(stopwatchseconds)[1]}:${getTime(stopwatchseconds)[2]}`;
		document.getElementById('timernumber1').innerHTML = `${getTime(stopwatchseconds)[1]}:${getTime(stopwatchseconds)[2]}`;
		document.getElementById('timernumber2').innerHTML = `${getTime(stopwatchseconds)[1]}:${getTime(stopwatchseconds)[2]}`;
	}else if(currentTimer == 'Pomodoro'){
		document.getElementById('timernumber').innerHTML = `${getTime(pomodoroseconds)[0]}:${getTime(pomodoroseconds)[1]}`;
		document.getElementById('timernumber1').innerHTML = `${getTime(pomodoroseconds)[0]}:${getTime(pomodoroseconds)[1]}`;
		document.getElementById('timernumber2').innerHTML = `${getTime(pomodoroseconds)[0]}:${getTime(pomodoroseconds)[1]}`;
	}
}
